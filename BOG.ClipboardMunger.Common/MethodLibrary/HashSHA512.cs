...
{
    public class HashSHA512 : ClipboardMungerProviderBase, IClipboardMungerProvider
    {
        public override string MethodName { get => "Hash value (SHA512)"; }
        public override string GroupName { get => "Encoding"; }
        public override string Description { get => "Return the SHA512 hash value of the clipboard content"; }
