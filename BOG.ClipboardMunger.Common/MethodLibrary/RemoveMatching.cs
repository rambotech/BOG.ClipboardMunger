...
{
	public class RemoveMatching : ClipboardMungerProvider, IClipboardMungerProvider
	{
		...
		public override string Munge(string textToMunge)
		{
			...
			var lineIndex = 0;
			foreach (string ThisLine in textToMunge.Split(new string[] { lineEnding }, StringSplitOptions.RemoveEmptyEntries))
			{
				lineIndex++;
